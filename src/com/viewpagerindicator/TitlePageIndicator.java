...
public class TitlePageIndicator extends View implements PageIndicator {
	...
	public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultFooterColor = res.getColor(R.color.android_thick_orange);
        ...
        final int defaultSelectedColor = res.getColor(R.color.android_thick_orange);
        final boolean defaultSelectedBold = res.getBoolean(R.bool.default_title_indicator_selected_bold);
        final int defaultTextColor = res.getColor(R.color.android_thick_orange);
    ...
    public void setViewPager(ViewPager view) {
        ...
        mViewPager = view;
        //get the onpagechangelistener from the view
        mListener = (ViewPager.OnPageChangeListener)(view.getAdapter());
        //set this onpagechangelistener to the mViewPager
