...
public final class SystemUtil
{
    ...
    {
        if ("com.thtfit.pos".equals(context.getPackageName()))
        {
            return AppName.THTFITPOS;
        }
    ...
    {
        if (getBrand(context) == AppName.THTFITPOS)
        {
            return context.getResources().getColor(R.color.thtfitpos);
        } else
        {
