...
////         CryptoHelper, GeneralApi, Utils, HttpPatch
//
//class HttpHelper2 {
//
...
//        {
//            Utils.logJson((new StringBuilder("URL: ")).append(s).toString());
//            Utils.logJson((new StringBuilder("Request: ")).append(s1).toString());
//        }
//        i = 0;
...
//            if (GeneralApi.isDebuggable())
//            {
//                Utils.logJson((new StringBuilder("Response: ")).append(s6).toString());
//            }
//        return s6;
//        _L4:
