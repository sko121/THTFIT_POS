...
public final class Hacks {
	...
	private static final boolean isADR6400() {
		return Build.MODEL.startsWith("ADR6400")
				|| Build.DEVICE.startsWith("ADR6400");
	} // HTC Thunderbolt
	...
	/*
	 * private static final boolean log(final String msg) { Log.d(msg); return
	 * true; }
	 */

	/*
	 * Not working as now Calling from Galaxy S to PC is "usable" even with no
	 * hack; other side is not even with this one
	 */
	public static void galaxySSwitchToCallStreamUnMuteLowerVolume(
			AudioManager am) {
	...
	public static boolean hasCamera() {
		if (Version.sdkAboveOrEqual(9)) {
			int nb = 0;
			try {
				nb = (Integer) Camera.class.getMethod("getNumberOfCameras",
		...
		Log.i("mediastreamer",
				"Hack: considering there IS a camera.\n"
