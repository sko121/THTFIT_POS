...
/**
 * Entry point for accessing hardware cameras configuration. Different SDK
 * implementations are delegated to specific AndroidCameraConfN versions.
 * 
 */
public class AndroidCameraConfiguration {
	...
	private static void initCamerasCache() {
		...
		try {
			...
			Log.e("mediastreamer",
					"Error: cannot retrieve cameras information (busy ?)", exc);
			exc.printStackTrace();
