...
public interface LinphoneCoreListener {
	 ...
	 * @return
	 * */
	void globalState(LinphoneCore lc, LinphoneCore.GlobalState state,
			String message);
	 ...
	 * @return
	 * */
	void callState(LinphoneCore lc, LinphoneCall call,
			LinphoneCall.State cstate, String message);

	/**
	 * Callback to display change in encryption state.
	 * 
	 * @param encrypted
	 *            true if all streams of the call are encrypted
	 * @param authenticationToken
	 *            token like ZRTP SAS that may be displayed to user
	 */
	void callEncryptionChanged(LinphoneCore lc, LinphoneCall call,
	 ...
	 * decision. Status on this subscription request is notified by changing
	 * policy for this friend
	 * 
	 * @param lc
	 *            LinphoneCore
	 * @param lf
	 ...
	 *            LinphoneCore
	 * @param room
	 *            LinphoneChatRoom involved in this conversation. Can be be
	 *            created by the framework in case the from is not present in
	 *            any chat room.
	 * @param from
	 ...
	 *            incoming message
	 */
	void textReceived(LinphoneCore lc, LinphoneChatRoom cr,
	 ...
	 * @param data
	 */
	void ecCalibrationStatus(LinphoneCore lc,
