...
/**
 * Interface to implement for handling liblinphone log. <br>
 * use {@link LinphoneCoreFactory#setLogHandler(LinphoneLogHandler)}
 * 
 */
public interface LinphoneLogHandler {
	 ...
	 * @param e
	 */
	public void log(String loggerName, int level, String levelString,
