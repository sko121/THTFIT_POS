 ...
 * {@link LinphoneCore#invite(LinphoneAddress)} or passed to the application by
 * listener
 * {@link LinphoneCoreListener#callState(LinphoneCore, LinphoneCall, State, String)}
 * 
 */
...
public interface LinphoneCall {
	...
	static class State {
		 ...
		 */
		public final static State IncomingReceived = new State(1,
				"IncomingReceived");
		/**
		 ...
		 */
		public final static State OutgoingProgress = new State(3,
				"OutgoingProgress");
		/**
		 * Outgoing call ringing.
		 */
		public final static State OutgoingRinging = new State(4,
				"OutgoingRinging");
		/**
		 * Outgoing call early media
		 */
		public final static State OutgoingEarlyMedia = new State(5,
				"OutgoingEarlyMedia");
		/**
		 * Connected
		 */
		 ...
		 * Streams running
		 */
		public final static State StreamsRunning = new State(7,
				"StreamsRunning");
		/**
		 * Pausing
		 */
		 ...
		 * Paused by remote
		 */
		public final static State PausedByRemote = new State(14,
				"PausedByRemote");

		/**
		 * The call's parameters are updated, used for example when video is
		 * asked by remote
		 */
		public static final State CallUpdatedByRemote = new State(15,
				"CallUpdatedByRemote");

		/**
		 * We are proposing early media to an incoming call
		 */
		public static final State CallIncomingEarlyMedia = new State(16,
	...
	/**
	 * Returns the object associated to a call this one is replacing. Call
	 * replacement can occur during transfer scenarios.
	 */
	 ...
	 * computed and updated during all the duration of the call. This function
	 * returns its value at the time of the function call. It is expected that
	 * the rating is updated at least every 5 seconds or so. The rating is a
	 * floating point number comprised between 0 and 5.
	 * 
	 * 4-5 = good quality <br>
	 ...
	 * 
	 * @returns The function returns -1 if no quality measurement is available,
	 *          for example if no active audio stream exist. Otherwise it
	...
	/**
	 * Used by ZRTP encryption mechanism. SAS can be verified manually by the
	 * user or automatically using a previously shared secret.
	 * 
	 ...
	 * 
	 * @param verified
	 *            true when displayed SAS is correct
	 */
	...
	public int startRecording(final String strFilePath);
