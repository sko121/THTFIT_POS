...
public class OnlineStatus {
	 ...
	 * Do Not Disturb
	 */
	static public OnlineStatus DoNotDisturb = new OnlineStatus(7,
			"DoNotDisturb");
	/**
	 * Moved in this sate, call can be redirected if an alternate contact
	 * address has been set using function
	 * {@link LinphoneCore#setPresenceInfo(int, String, OnlineStatus)}
	 */
	static public OnlineStatus StatusMoved = new OnlineStatus(8, "StatusMoved");
	/**
	 * Using another messaging service
	 */
	static public OnlineStatus StatusAltService = new OnlineStatus(9,
			"StatusAltService");
	/**
	 * Pending
	 */
