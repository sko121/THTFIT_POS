...
public class CallManager {
	...
	void inviteAddress(LinphoneAddress lAddress, boolean videoEnabled)
	...
	boolean reinviteWithVideo() {
		...
		/*	//we are using LAN, bandwidth is not a problem.
	...
	/**
	 * Change the preferred video size used by linphone core. (impact
	 * landscape/portrait buffer). Update current call, without reinvite. The
	 * camera will be restarted when mediastreamer chain is recreated and
