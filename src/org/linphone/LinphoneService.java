...
public final class LinphoneService extends Service {
	private final static int ic_launcher=R.drawable.ic_launcher; 
...
//	private boolean mTestDelayElapsed; // add a timer for testing
	...
	public void onCreate() {
		...
		Bitmap bm = null;
		try {
			bm = BitmapFactory.decodeResource(getResources(), ic_launcher);
		} catch (Exception e) {
		}
		mNotif = Compatibility.createNotification(this, mNotificationTitle, "", R.drawable.linphone_notification_icon, ic_launcher, bm, mNotifContentIntent, true,notifcationsPriority);
