...
/**
 * 
 * Intercept network state changes and update linphone core through
 * LinphoneManager.
 * 
 */
public class NetworkManager extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (lNoConnectivity	| ((lNetworkInfo.getState() == NetworkInfo.State.DISCONNECTED) )) {
			LinphoneManager.getLc().setNetworkReachable(Network.isReachable(context));
			...
			if (lNetworkInfo.getTypeName().equals("WIFI")
					|| (lNetworkInfo.getTypeName().equals("mobile") && !wifiOnly)
					|| (lNetworkInfo.getTypeName().equals("ETHERNET") && !wifiOnly)) {
