...
LOCAL_STATIC_JAVA_LIBRARIES := activate support  dspread  gson  javamail  ZCSCombo mpandroidchar  pushservice  universal   libarityXml    

LOCAL_STATIC_LIBRARIES := liba01jni libbdpush_V2_2 lib_serial_port libJNIEMV libJNISerial libwltdecode
...
LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES := activate:libs/activation.jar \
					...
					ZCSCombo:libs/ZCSComboV2.5.jar \
